...
import RenderNavigation from "../../app/dashboard-app/navigation";
import { sideBarNavigationItems } from "../../app/dashboard-app/navigation/constants";
	...
	return (
		<aside
			...
			className={`fixed min-h-dvh transition-all border ${isFullWidth
				...
				: " w-[0] lg:w-[55px] lg:max-w-[55px] lg:min-w-[55px] "}`}>
			<div className="flex flex-col h-[50px] items-center justify-center">
				...
				<button
					...
					type="button">
					<SystemIconsCmp icon="menuBar" iconStyle="h-6 w-6" />
				</button>
			</div>
		</aside>
	);
